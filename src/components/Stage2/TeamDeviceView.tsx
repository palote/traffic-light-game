    ...
    return (
      <div style={{ ...styles.container, padding: 24 }}>
        <div style={{ ...styles.phaseCard("hint"), textAlign: "center" }}>
          <div style={{ fontSize: 48, marginBottom: 16 }}>❌</div>
          <div style={{ fontSize: 18 }}>No se encontró el equipo <strong>{teamId}</strong></div>
        </div>
      </div>
    );
  }
        ...
        <div style={styles.content}>
          <div style={styles.waitingCard}>
            ...
            <div style={{ fontSize: 14, color: "#64748b", marginTop: 8 }}>
              Stage 2 todavía no fue iniciado
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={styles.header}>
        ...
        <div style={styles.statRow}>
          <div style={styles.statItem}>
            <span>🏆</span>
            <span><strong>{team.totalScore ?? 0}</strong> pts</span>
          </div>
          <div style={styles.statItem}>
            <span>📍</span>
      ...
      <div style={styles.content}>
          ...
          <div style={styles.phaseCard("hint")}>
            ...
            <div style={styles.infoBox}>
              <p style={{ margin: 0, fontSize: 15, color: "#64748b" }}>
                💬 Discutan en equipo la estrategia
              </p>
            ...
            {isRespondingTeam && responding && (
              <div style={{ ...styles.successCard, backgroundColor: "#f97316" }}>
                ...
                <div style={{ fontSize: 14, marginTop: 12, opacity: 0.9 }}>
                  Pasá al frente debajo de tu equipo
                </div>
              </div>
            )}
            ...
            {isRespondingTeam ? (
              <>
                <div style={{ 
                  ...
                  <div style={{ fontSize: 15, color: "#78716c", marginTop: 8 }}>
                    Respondé oralmente al frente
                  </div>
                </div>
          ...
          <div style={styles.phaseCard("responding_with_help")}>
            ...
            {isRespondingTeam ? (
              <>
                ...
                <div style={styles.infoBox}>
                  <p style={{ margin: 0, fontSize: 15 }}>
                    💬 Discutí con tu equipo y preparate para responder
                  </p>
                </div>
              </>
            ) : (
            ...
            {isRaterTeam ? (
              !hasRated ? (
                <>
                  ...
                  <button
                    onClick={() => handleSubmitRating("green")}
                    style={styles.ratingBtn("#22c55e", false)}
                  >
                    <div>🟩 VERDE</div>
                  ...
                  <button
                    onClick={() => handleSubmitRating("yellow")}
                    style={styles.ratingBtn("#eab308", false)}
                  >
                    <div>🟨 AMARILLO</div>
                  ...
                  <button
                    onClick={() => handleSubmitRating("red")}
                    style={styles.ratingBtn("#ef4444", false)}
                  >
                    <div>🟥 ROJO</div>
        ...
        {phase === "rating_reveal" && (
          <div style={styles.phaseCard("rating_reveal")}>
            ...
            {isRaterTeam && myRaterData ? (
              <div style={{ 
                backgroundColor: myRaterData.rating === "green" ? "#22c55e" 
                  : myRaterData.rating === "yellow" ? "#eab308" 
                  : "#ef4444",
                color: "white",
                borderRadius: 16,
                padding: 32,
