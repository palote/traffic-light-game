...
// Modal para editar metadata de un juego guardado
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onSave({
        ...
        area,
        subject: game.gameMode === 'coopetition' ? subject : undefined,
        grade: game.gameMode === 'traffic-light' ? grade : undefined,
        topic: topic.trim(),
        ...
        <form onSubmit={handleSubmit} style={{ padding: 24 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              ...
              <span>🎮 {game.gameMode === 'coopetition' ? 'Coopetition' : 'Traffic Light'}</span>
              <span>{game.visibility === 'public' ? '🌐 Público' : '🔒 Privado'}</span>
            </div>
          </div>
